...
import CustomerUserFormContainer from "../../../crm/users/customers/CustomerUserFormContainer";
import CustomerUserList from "../../../crm/users/customers/CustomerUserList";
...
function CrmCustomerUsersLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/crm/users/customerusers/new"),
                ]}
              >
                Add Customer User
              </Button>
        ...
        <Grid item className={classes.contentContainer}>
          <CustomerUserList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
