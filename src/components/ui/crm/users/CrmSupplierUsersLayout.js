...
import SupplierList from "../../../crm/users/suppliers/SupplierList";
import SupplierFormContainer from "../../../crm/users/suppliers/SupplierFormContainer";
...
function CrmSupplierUsersLayout(props) {
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/crm/users/supplierusers/new"),
                ]}
              >
                Add A Supplier User
              </Button>
...
export default CrmSupplierUsersLayout;
