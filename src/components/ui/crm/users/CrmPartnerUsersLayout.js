...
import PartnerUsersFormContainer from "../../../crm/users/partners/PartnerUsersFormContainer";
import PartnerUsersList from "../../../crm/users/partners/PartnerUsersList";
...
function CrmPartnerUsersLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/crm/users/partnerusers/new"),
                ]}
              >
                Add A Partner User
              </Button>
        ...
        <Grid item className={classes.contentContainer}>
          <PartnerUsersList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
      <Dialog
        ...
        onClose={() => [
          setOpen(false),
          history.push("/crm/users/partnerusers"),
        ]}
      >
        <DialogContent>
          <PartnerUsersFormContainer
            token={props.token}
...
export default CrmPartnerUsersLayout;
