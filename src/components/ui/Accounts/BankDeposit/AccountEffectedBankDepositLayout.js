...
import AccountEffectedBankDepositList from "../../../accounts/bankDeposits/AccountEffectedBankDepositList";
...
function AccountEffectedBankDepositLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountEffectedBankDepositList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
...
export default AccountEffectedBankDepositLayout;
