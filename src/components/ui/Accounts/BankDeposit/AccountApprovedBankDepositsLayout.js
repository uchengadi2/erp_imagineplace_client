...
import AccountApprovedBankDepositList from "../../../accounts/bankDeposits/AccountApprovedBankDepositList";
...
function AccountApprovedBankDepositsLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountApprovedBankDepositList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
...
export default AccountApprovedBankDepositsLayout;
