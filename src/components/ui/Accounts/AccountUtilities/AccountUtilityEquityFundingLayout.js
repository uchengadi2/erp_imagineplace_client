...
import AccountUtilityEquityFundingList from "../../../accounts/utilities/equity/AccountUtilityEquityFundingList";
...
function AccountUtilityEquityFundingLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/accounts/utilities/equity/new"),
                ]}
              >
                Fund Equity Account
              </Button>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountUtilityEquityFundingList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
...
export default AccountUtilityEquityFundingLayout;
