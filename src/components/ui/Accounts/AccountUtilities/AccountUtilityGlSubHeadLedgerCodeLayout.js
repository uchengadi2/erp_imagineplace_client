...
import GeneralLedgerFilter from "../../headerFilters/GeneralLedgerCodeFilter";
import AccountUtilitySubLedgerList from "../../../accounts/utilities/subgl/AccountUtilitySubLedgerList";
import AccountUtilityGlSubHeadCodeFormContainer from "../../../accounts/utilities/subgl/AccountUtilityGlSubHeadCodeFormContainer";
...
function AccountUtilityGlSubHeadLedgerCodeLayout(props) {
  ...
  return (
    ...
    >
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/accounts/utilities/glsubheadcodes/new"),
                ]}
              >
      ...
      <Dialog
        ...
        onClose={() => [
          setOpen(false),
          history.push("/accounts/utilities/glsubheadcodes"),
        ]}
      >
        <DialogContent>
          <AccountUtilityGlSubHeadCodeFormContainer
            token={props.token}
...
export default AccountUtilityGlSubHeadLedgerCodeLayout;
