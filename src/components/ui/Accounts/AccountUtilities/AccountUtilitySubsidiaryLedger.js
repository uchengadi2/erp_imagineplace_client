...
import SchemeTypeFilter from "../../headerFilters/SchemeTypeFilter";
import AccountUtilitySchemeCodesList from "../../../accounts/utilities/accountTypes/AccountUtilitySchemeCodesList";
import SchemeCodeFormContainer from "../../../accounts/utilities/accountTypes/SchemeCodeFormContainer";
...
function AccountUtilitySubsidiaryLedger(props) {
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/accounts/utilities/subledgers/new"),
                ]}
              >
...
export default AccountUtilitySubsidiaryLedger;
