...
import AccountUtilityCashAccountList from "../../../accounts/utilities/cash/AccountUtilityCashAccountList";
...
function AccountUtilityCashAccountLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/accounts/utilities/cash/new"),
                ]}
              >
                Fund Cash Account
              </Button>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountUtilityCashAccountList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
...
export default AccountUtilityCashAccountLayout;
