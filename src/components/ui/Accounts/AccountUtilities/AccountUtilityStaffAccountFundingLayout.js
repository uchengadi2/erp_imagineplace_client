...
import AccountUtilityStaffAccountFundingList from "../../../accounts/utilities/staffAccount/AccountUtilityStaffAccountFundingList";
...
function AccountUtilityStaffAccountFundingLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/accounts/utilities/staffaccount/new"),
                ]}
              >
                Fund Staff Account
              </Button>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountUtilityStaffAccountFundingList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
      <Dialog
        ...
        onClose={() => [
          setOpen(false),
          history.push("/accounts/utilities/staffaccount"),
        ]}
      >
        <DialogContent>
          {/* <OrderFormContainer
...
export default AccountUtilityStaffAccountFundingLayout;
