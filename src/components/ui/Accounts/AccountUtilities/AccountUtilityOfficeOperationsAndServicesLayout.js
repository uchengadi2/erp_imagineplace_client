...
import AccountUtilityOfficeOperationAndServicesList from "../../../accounts/utilities/officeOperations/AccountUtilityOfficeOperationAndServicesList";
import AccountUtilityOfficeOperationsFormContainer from "../../../accounts/utilities/officeOperations/AccountUtilityOfficeOperationsFormContainer";
...
function AccountUtilityOfficeOperationsAndServicesLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/accounts/utilities/officeoperations/new"),
                ]}
              >
        ...
        <Grid item className={classes.contentContainer}>
          <AccountUtilityOfficeOperationAndServicesList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
      ...
      >
        <DialogContent>
          <AccountUtilityOfficeOperationsFormContainer
            token={props.token}
...
export default AccountUtilityOfficeOperationsAndServicesLayout;
