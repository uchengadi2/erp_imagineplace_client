...
import AccountListingBalanceSheetList from "../../../accounts/listings/balanceSheet/AccountListingBalanceSheetList";
...
function AccountListingBalanceSheetLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountListingBalanceSheetList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
...
export default AccountListingBalanceSheetLayout;
