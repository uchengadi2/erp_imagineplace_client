...
import AccountListingTrailBalanceListing from "./../../../accounts/listings/trailBalance/AccountListingTrialBalanceListing";
...
function AccountListingTrailBalanceLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountListingTrailBalanceListing token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
...
export default AccountListingTrailBalanceLayout;
