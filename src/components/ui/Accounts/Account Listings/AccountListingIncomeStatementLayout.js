...
import AccountGeneralLedgerList from "../../../accounts/Ledgers/generalLedger/AccountGeneralLedgerList";

import ServiceOutLetsAndDateFilters from "../../headerFilters/ServiceOutLetsAndDateFilters";
import AccountListingIncomeStatementList from "../../../accounts/listings/incomeStatement/AccountListingIncomeStatementList";
...
function AccountListingIncomeStatementLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountListingIncomeStatementList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
      <Dialog
        ...
        open={open}
        onClose={() => [setOpen(false), history.push("/accounts/listings")]}
      >
        <DialogContent>
          {/* <OrderFormContainer
            token={props.token}
...
export default AccountListingIncomeStatementLayout;
