...
import AccountListingJournalList from "../../../accounts/listings/journals/AccountListingJournalList";
...
function AccountListingJournalsLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountListingJournalList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
...
export default AccountListingJournalsLayout;
