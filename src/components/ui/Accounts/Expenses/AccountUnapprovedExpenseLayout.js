...
import AccountExpensesList from "../../../accounts/expenses/AccountUnapprovedExpensesList";

import ServiceOutLetsAndDateFilters from "../../headerFilters/ServiceOutLetsAndDateFilters";
import AccountUnapprovedExpensesList from "../../../accounts/expenses/AccountUnapprovedExpensesList";
...
function AccountUnapprovedExpenseLayout({ token }) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountUnapprovedExpensesList token={token} />
        </Grid>
      </Grid>
      <Dialog
        //style={{ zIndex: 1302 }}
...
export default AccountUnapprovedExpenseLayout;
