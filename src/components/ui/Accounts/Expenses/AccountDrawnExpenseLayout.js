...
import AccountDrawnExpensesList from "../../../accounts/expenses/AccountDrawnExpensesList";
...
function AccountDrawnExpenseLayout({ token }) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountDrawnExpensesList token={token} />
        </Grid>
      </Grid>
      <Dialog
        //style={{ zIndex: 1302 }}
...
export default AccountDrawnExpenseLayout;
