...
import AccountApprovedExpensesList from "./../../../accounts/expenses/AccountApprovedExpensesList";
...
function AccountApprovedExpenseLayout({ token }) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountApprovedExpensesList token={token} />
        </Grid>
      </Grid>
      <Dialog
        //style={{ zIndex: 1302 }}
...
export default AccountApprovedExpenseLayout;
