...
import AccuntEmployeeTrainingList from "../../../accounts/employees/AccuntEmployeeTrainingList";
...
function AccountEmployeeTrainingsLayout({ token }) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AccuntEmployeeTrainingList token={token} />
        </Grid>
      </Grid>
      <Dialog
        //style={{ zIndex: 1302 }}
...
export default AccountEmployeeTrainingsLayout;
