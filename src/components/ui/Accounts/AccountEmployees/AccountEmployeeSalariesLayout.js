...
import AccountEmployeeSalariesList from "./../../../accounts/employees/AccountEmployeeSalariesList";
...
function AccountEmployeeSalariesLayout({ token }) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountEmployeeSalariesList token={token} />
        </Grid>
      </Grid>
      <Dialog
        //style={{ zIndex: 1302 }}
...
export default AccountEmployeeSalariesLayout;
