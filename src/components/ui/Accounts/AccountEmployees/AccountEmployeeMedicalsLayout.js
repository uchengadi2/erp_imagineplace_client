...
import AccountEmployeeMedicalList from "./../../../accounts/employees/AccountEmployeeMedicalList";
...
function AccountEmployeeMedicalsLayout({ token }) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountEmployeeMedicalList token={token} />
        </Grid>
      </Grid>
      <Dialog
        //style={{ zIndex: 1302 }}
...
export default AccountEmployeeMedicalsLayout;
