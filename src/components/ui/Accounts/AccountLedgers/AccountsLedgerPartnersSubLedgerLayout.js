...
import AccountsPartnersLedgerFormContainer from "../../../accounts/Ledgers/subLedger/partners/AccountsPartnersLedgerFormContainer";
import AccountsPartnersLedgerList from "../../../accounts/Ledgers/subLedger/partners/AccountsPartnersLedgerList";
...
function AccountsLedgerPartnersSubLedgerLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        >
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              ...
              >
                Create Partner Sub-ledger Account
              </Button>
            </Grid>
            <Grid item></Grid>
          </Toolbar>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountsPartnersLedgerList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
      ...
      >
        <DialogContent>
          <AccountsPartnersLedgerFormContainer
            token={props.token}
...
export default AccountsLedgerPartnersSubLedgerLayout;
