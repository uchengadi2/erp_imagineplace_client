...
import AccountsLedgerSuppliersSubledgerFormContainer from "../../../accounts/Ledgers/subLedger/suppliers/AccountsLedgerSuppliersSubledgerFormContainer";
import ServiceOutletAndSubGlHeadFilter from "../../headerFilters/ServiceOutletAndSubGlHeadFilter";
import AccountsLedgerSuppliersSubLedgerList from "../../../accounts/Ledgers/subLedger/suppliers/AccountsLedgerSuppliersSubLedgerList";
...
function AccountsLedgerSuppliersSubLedgersLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/accounts/ledgers/supplierssubledgers/new"),
                ]}
              >
                Create Supplier Sub-ledger Account
              </Button>
            </Grid>
            <Grid item></Grid>
          </Toolbar>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountsLedgerSuppliersSubLedgerList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
      ...
      >
        <DialogContent>
          <AccountsLedgerSuppliersSubledgerFormContainer
            token={props.token}
...
export default AccountsLedgerSuppliersSubLedgersLayout;
