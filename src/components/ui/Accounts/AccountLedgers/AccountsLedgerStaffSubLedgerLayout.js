...
import AccountLedgerStaffSubLedgerList from "../../../accounts/Ledgers/subLedger/staff/AccountLedgerStaffSubLedgerList";
import ServiceOutletAndSubGlHeadFilter from "../../headerFilters/ServiceOutletAndSubGlHeadFilter";
import AccountLederStaffSubLedgerFormContainer from "../../../accounts/Ledgers/subLedger/staff/AccountLederStaffSubLedgerFormContainer";
...
function AccountsLedgerStaffSubLedgerLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/accounts/ledgers/staffsubledgers/new"),
                ]}
              >
                Create Staff Sub-Ledger Account
              </Button>
            </Grid>
            <Grid item></Grid>
          </Toolbar>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountLedgerStaffSubLedgerList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
      ...
      >
        <DialogContent>
          <AccountLederStaffSubLedgerFormContainer
            token={props.token}
...
export default AccountsLedgerStaffSubLedgerLayout;
