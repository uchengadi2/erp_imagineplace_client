...
import AccountSubledgerList from "../../../accounts/Ledgers/subLedger/assets/AccountSubLedgerList";

import ServiceOutletAndSubGlHeadFilter from "../../headerFilters/ServiceOutletAndSubGlHeadFilter";
import AccountsLedgersSubLedgerFormContainer from "../../../accounts/Ledgers/subLedger/assets/AccountsLedgersSubLedgerFormContainer";
...
function AccountsSubLedgerLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/accounts/ledgers/subledgers/new"),
                ]}
              >
                Create Asset Sub-ledger Account
              </Button>
            </Grid>
            <Grid item></Grid>
          </Toolbar>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountSubledgerList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
      <Dialog
        ...
        onClose={() => [
          setOpen(false),
          history.push("/accounts/ledgers/subledgers"),
        ]}
        style={{ marginTop: 60 }}
      >
        <DialogContent>
          <AccountsLedgersSubLedgerFormContainer
            token={props.token}
...
export default AccountsSubLedgerLayout;
