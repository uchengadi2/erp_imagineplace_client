...
import AccountsLedgerProductsSubLedgerList from "../../../accounts/Ledgers/subLedger/products/AccountsLedgerProductsSubLedgerList";
import AccountsLedgerProductSubLedgerFormContainer from "../../../accounts/Ledgers/subLedger/products/AccountsLedgerProductSubLedgerFormContainer";
...
function AccountsLedgerProductsSubLedgerLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/accounts/ledgers/partnerssubledgers/new"),
                ]}
              >
                Create Product Sub-ledger Account
              </Button>
            </Grid>
            <Grid item></Grid>
          </Toolbar>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountsLedgerProductsSubLedgerList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
      ...
      >
        <DialogContent>
          <AccountsLedgerProductSubLedgerFormContainer
            token={props.token}
...
export default AccountsLedgerProductsSubLedgerLayout;
