...
import AccountsLedgerCustomersSubledgerFormContainer from "../../../accounts/Ledgers/subLedger/customers/AccountsLedgerCustomersSubledgerFormContainer";
import ServiceOutletAndSubGlHeadFilter from "../../headerFilters/ServiceOutletAndSubGlHeadFilter";
import AccountsLedgerCustomersSubLedgerList from "../../../accounts/Ledgers/subLedger/customers/AccountsLedgerCustomersSubLedgerList";
...
function AccountsLedgerCustomersSubLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountsLedgerCustomersSubLedgerList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
      ...
      >
        <DialogContent>
          <AccountsLedgerCustomersSubledgerFormContainer
            token={props.token}
...
export default AccountsLedgerCustomersSubLayout;
