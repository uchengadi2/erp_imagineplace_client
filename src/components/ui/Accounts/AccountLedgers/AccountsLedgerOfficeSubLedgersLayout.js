...
import AccountsLedgerOfficeSubLedgerFormContainer from "../../../accounts/Ledgers/subLedger/officeOperations/AccountsLedgerOfficeSubLedgerFormContainer";
import AccountsLedgerOfficeSubLedgerList from "../../../accounts/Ledgers/subLedger/officeOperations/AccountsLedgerOfficeSubLedgerList";
...
function AccountsLedgerOfficeSubLedgersLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/accounts/ledgers/customerssubledgers/new"),
                ]}
              >
                Create Office Sub-ledger Account
              </Button>
            </Grid>
            <Grid item></Grid>
          </Toolbar>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountsLedgerOfficeSubLedgerList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
      ...
      >
        <DialogContent>
          <AccountsLedgerOfficeSubLedgerFormContainer
            token={props.token}
...
export default AccountsLedgerOfficeSubLedgersLayout;
