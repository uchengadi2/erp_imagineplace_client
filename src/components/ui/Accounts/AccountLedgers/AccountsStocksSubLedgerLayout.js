...
import AccountLedgerStockSubLedgerList from "../../../accounts/Ledgers/subLedger/stocks/AccountLedgerStockSubLedgerList";

import ServiceOutletAndSubGlHeadFilter from "../../headerFilters/ServiceOutletAndSubGlHeadFilter";
import AccountLedgerStockSubLedgerFormContainer from "../../../accounts/Ledgers/subLedger/stocks/AccountLedgerStockSubLedgerFormContainer";
...
function AccountsStocksSubLedgerLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/accounts/ledgers/stockssubledgers/new"),
                ]}
              >
                Create Stock Sub-ledger Account
              </Button>
            </Grid>
            <Grid item></Grid>
          </Toolbar>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountLedgerStockSubLedgerList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
      ...
      >
        <DialogContent>
          <AccountLedgerStockSubLedgerFormContainer
            token={props.token}
...
export default AccountsStocksSubLedgerLayout;
