...
import AccountLedgerVendorSubLedgerFormContainer from "../../../accounts/Ledgers/subLedger/vendors/AccountLedgerVendorSubLedgerFormContainer";
import ServiceOutletAndSubGlHeadFilter from "../../headerFilters/ServiceOutletAndSubGlHeadFilter";
import AccountLedgerVendorSubLedgerList from "../../../accounts/Ledgers/subLedger/vendors/AccountLedgerVendorSubLedgerList";
...
function AccountsLedgerVendorSubLedgerLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/accounts/ledgers/vendorssubledgers/new"),
                ]}
              >
                Create Vendor Sub-ledger Account
              </Button>
            </Grid>
            <Grid item></Grid>
          </Toolbar>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountLedgerVendorSubLedgerList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
      <Dialog
        ...
        onClose={() => [
          setOpen(false),
          history.push("/accounts/ledgers/vendorssubledgers"),
        ]}
        style={{ marginTop: 60 }}
      >
        <DialogContent>
          <AccountLedgerVendorSubLedgerFormContainer
            token={props.token}
...
export default AccountsLedgerVendorSubLedgerLayout;
