...
import AccountRecievedInflowList from "./../../../accounts/Inflows/AccountRecievedInflowList";
...
function AccountRecievedinflowsLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountRecievedInflowList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
...
export default AccountRecievedinflowsLayout;
