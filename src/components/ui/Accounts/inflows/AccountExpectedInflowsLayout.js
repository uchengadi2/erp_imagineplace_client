...
import AccountExpectedInflowList from "../../../accounts/Inflows/AccountExpectedInflowList";
...
function AccountExpectedInflowsLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountExpectedInflowList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
      <Dialog
        ...
        open={open}
        onClose={() => [setOpen(false), history.push("/accounts/inflows")]}
      >
        <DialogContent>
          {/* <OrderFormContainer
            token={props.token}
...
export default AccountExpectedInflowsLayout;
