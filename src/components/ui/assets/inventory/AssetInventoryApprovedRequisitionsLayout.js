...
import AssetInventoryApprovedRequisitionList from "../../../assets/inventory/approvedRequisitions/AssetInventoryApprovedRequisitionList";
...
function AssetInventoryApprovedRequisitionsLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AssetInventoryApprovedRequisitionList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
...
export default AssetInventoryApprovedRequisitionsLayout;
