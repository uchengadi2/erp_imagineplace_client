...
import AssetInventoryApprovedDisposalList from "../../../assets/inventory/approvedDisposals/AssetInventoryApprovedDisposalList";
...
function AssetInventoryApprovedDisposalLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AssetInventoryApprovedDisposalList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
...
export default AssetInventoryApprovedDisposalLayout;
