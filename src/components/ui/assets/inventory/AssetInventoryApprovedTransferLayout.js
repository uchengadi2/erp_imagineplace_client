...
import AssetInventoryApprovedTransferList from "../../../assets/inventory/approvedTrsnsfers/AssetInventoryApprovedTransferList";
...
function AssetInventoryApprovedTransferLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
            ...
            <Grid item>
              {/* <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push(
                    "/assets/inventories/approvedrequisitions/new"
                  ),
                ]}
              >
        ...
        <Grid item className={classes.contentContainer}>
          <AssetInventoryApprovedTransferList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
      <Dialog
        ...
        onClose={() => [
          setOpen(false),
          history.push("/assets/inventories/approvetransfers"),
        ]}
      >
        <DialogContent>
          {/* <OrderFormContainer
...
export default AssetInventoryApprovedTransferLayout;
