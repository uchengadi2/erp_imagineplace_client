...
import AssetInventoryApprovedRetirementList from "../../../assets/inventory/approvedRetirements/AssetInventoryApprovedRetirementList";
...
function AssetInventoryApprovedRetirementsLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AssetInventoryApprovedRetirementList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
...
export default AssetInventoryApprovedRetirementsLayout;
