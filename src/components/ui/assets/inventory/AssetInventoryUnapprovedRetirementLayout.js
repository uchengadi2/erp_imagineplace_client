...
import AssetInventoryUnapprovedRetirementList from "../../../assets/inventory/unapprovedRetirements/AssetInventoryUnapprovedRetirementList";
...
function AssetInventoryUnapprovedRetirementLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
            ...
            <Grid item>
              {/* <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push(
                    "/assets/inventories/unapprovedrequisitions/new"
                  ),
                ]}
              >
        ...
        <Grid item className={classes.contentContainer}>
          <AssetInventoryUnapprovedRetirementList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
...
export default AssetInventoryUnapprovedRetirementLayout;
