...
import AssetInventoryUnapprovedDisposalList from "../../../assets/inventory/unapprovedDisposals/AssetInventoryUnapprovedDisposalList";
...
function AssetInventoryUnapprovedDisposalLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AssetInventoryUnapprovedDisposalList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
...
export default AssetInventoryUnapprovedDisposalLayout;
