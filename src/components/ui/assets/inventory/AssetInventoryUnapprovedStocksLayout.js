...
import AssetInventoryUnapprovedRequisitionList from "../../../assets/inventory/unapprovedRequisitions/AssetInventoryUnapprovedRequisitionList";
...
function AssetInventoryUnapprovedStocksLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AssetInventoryUnapprovedRequisitionList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
...
export default AssetInventoryUnapprovedStocksLayout;
