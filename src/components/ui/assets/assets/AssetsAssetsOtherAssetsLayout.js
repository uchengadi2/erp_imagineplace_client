...
import AssetsOtherAssetsList from "./../../../assets/assets/otherAssets/AssetsOtherAssetsList";
...
function AssetsAssetsOtherAssetsLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AssetsOtherAssetsList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
...
export default AssetsAssetsOtherAssetsLayout;
