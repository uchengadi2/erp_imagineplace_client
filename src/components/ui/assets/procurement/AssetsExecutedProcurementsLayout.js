...
function AssetsExecutedProcurementsLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AssetExecutedProcurementList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
      <Dialog
        ...
        onClose={() => [
          setOpen(false),
          history.push("/assets/procurements/executed"),
        ]}
      >
        <DialogContent>
          {/* <OrderFormContainer
...
export default AssetsExecutedProcurementsLayout;
