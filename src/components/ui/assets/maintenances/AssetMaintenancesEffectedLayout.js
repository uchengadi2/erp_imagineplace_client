...
import AssetMaintenancesEffectedList from "../../../assets/maintenances/effected/AssetMaintenancesEffectedList";
...
function AssetMaintenancesEffectedLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AssetMaintenancesEffectedList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
...
export default AssetMaintenancesEffectedLayout;
