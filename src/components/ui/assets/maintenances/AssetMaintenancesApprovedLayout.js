...
import AssetMaintenancesApprovedList from "../../../assets/maintenances/approved/AssetMaintenancesApprovedList";
...
function AssetMaintenancesApprovedLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AssetMaintenancesApprovedList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
...
export default AssetMaintenancesApprovedLayout;
