...
import AssetsMaintenancesAllAssetsList from "../../../assets/maintenances/allAssets/AssetsMaintenancesAllAssetsList";
...
function AssetMaintenancesUnapprovedLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              {/* <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/assets/maintenances/unapproved/new"),
                ]}
              >
        ...
        <Grid item className={classes.contentContainer}>
          <AssetsMaintenancesAllAssetsList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
...
export default AssetMaintenancesUnapprovedLayout;
