...
import AssetTypesAndDatesFilter from "./../../headerFilters/AssetTypesAndDatesFilter";
import AssetProjectedDepreciationList from "./../../../assets/depreciation/projected/AssetProjectedDepreciationList";
...
function AssetProjectedDepreciationLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              {/* <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/assets/depreciations/projected/new"),
                ]}
              >
                Add Asset
              </Button> */}
        ...
        <Grid item className={classes.contentContainer}>
          <AssetProjectedDepreciationList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
...
export default AssetProjectedDepreciationLayout;
