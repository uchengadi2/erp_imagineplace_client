...
import AssetActualDepreciationList from "../../../assets/depreciation/actual/AssetActualDepreciationList";
...
function AssetActualDepreciationLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              {/* <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/assets/depreciations/actual/new"),
                ]}
              >
                Add Asset
              </Button> */}
        ...
        <Grid item className={classes.contentContainer}>
          <AssetActualDepreciationList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
...
export default AssetActualDepreciationLayout;
