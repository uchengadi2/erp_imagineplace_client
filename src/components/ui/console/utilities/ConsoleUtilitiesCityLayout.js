...
import StateFilter from "../../headerFilters/StateFilter";
import CityFormContainer from "../../../console/utilities/cities/CityFormContainer";
import CityList from "../../../console/utilities/cities/CityList";
...
function ConsoleUtilitiesCityLayout(props) {
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/systems/utilities/cities/new"),
                ]}
              >
                Add City
              </Button>
...
export default ConsoleUtilitiesCityLayout;
