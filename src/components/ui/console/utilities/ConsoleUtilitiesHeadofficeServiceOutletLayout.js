...
import HOServiceOutletFormContainer from "../../../console/utilities/hoServiceOutlet/HOServiceOutletFormContainer";
import HOServiceOutletList from "../../../console/utilities/hoServiceOutlet/HOServiceOutletList";
...
function ConsoleUtilitiesHeadofficeServiceOutletLayout(props) {
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/systems/utilities/hoserviceoutlets/new"),
                ]}
              >
...
export default ConsoleUtilitiesHeadofficeServiceOutletLayout;
