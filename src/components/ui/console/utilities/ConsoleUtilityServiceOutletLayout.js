...
import LocationFilter from "../../headerFilters/LocationFilter";
import ServiceOutletList from "../../../console/utilities/serviceOutlets/ServiceOutletList";
import ServiceOutletFormContainer from "../../../console/utilities/serviceOutlets/ServiceOutletFormContainer";
...
function ConsoleUtilityServiceOutletLayout(props) {
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/systems/utilities/serviceoutlets/new"),
                ]}
              >
...
export default ConsoleUtilityServiceOutletLayout;
