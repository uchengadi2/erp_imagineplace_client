...
import HrSelfServicesAppraisalsLayout from "./HrSelfServicesAppraisalsLayout";
...
function HrSelfServicesLayout({ token }) {
    ...
    <div className={classes.root}>
      ...
      >
        <Tab
          ...
          onClick={(event) => {
            event.preventDefault();
            history.push(`/hr/selfservices/leaves`);
          }}
        />
        <Tab
          label="Staff Loans"
        ...
        <Tab
          ...
          onClick={(event) => {
            event.preventDefault();
            history.push(`/hr/selfservices/certificaterefunds`);
          }}
        />
        <Tab
          label="Exit Request"
      ...
      <TabPanel value={value} index={0}>
        <HrSelfServicesLeaveLayout token={token} />
      </TabPanel>
