...
function ServiceOutletStatusAndDatesFilter(props) {
      ...
      <Box>
        <FormControl variant="outlined">
          ...
          >
            ...
            <MenuItem value="unapprovedAndMemorized">
              Unapproved But Memorized
            </MenuItem>
            <MenuItem value="approvedAndMemorized">
              Approved But Memorized
            </MenuItem>
            {/* {renderItemList()} */}
          </Select>
          <FormHelperText style={{ marginLeft: 20 }}>
