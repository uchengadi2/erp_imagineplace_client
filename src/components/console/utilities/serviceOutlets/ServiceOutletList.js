...
class ServiceOutletList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
    ...
    return (
      <>
        <Dialog
          ...
          onClose={() => [
            this.setState({ editOpen: false }),
            history.push("/utilities/serviceoutlets"),
          ]}
        >
          {/* <DialogContent>
            <StateEdit
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(`/utilities/serviceoutlets/edit/${params.id}`),
              ]}
            />
          </strong>
        ),
          ...
          <strong>
            ...
            <CancelRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/utilities/serviceoutlets/blacklist/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(`/utilities/serviceoutlets/delete/${params.id}`),
              ]}
            />
          </strong>
        ),
...
export default connect(mapStateToProps, { fetchStates })(ServiceOutletList);
