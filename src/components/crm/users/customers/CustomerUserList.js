...
class CustomerUserList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
    ...
    return (
      <>
        <Dialog
          ...
          onClose={() => [
            this.setState({ editOpen: false }),
            history.push("/crm/users/customerusers"),
          ]}
        >
          <DialogContent>
            {/* <CityEdit
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(`/crm/users/customerusers/edit/${params.id}`),
              ]}
            />
          </strong>
        ),
          ...
          <strong>
            ...
            <CancelRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(`/crm/users/customerusers/blacklist/${params.id}`),
              ]}
            />
          </strong>
        ),
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(`/crm/users/customerusers/delete/${params.id}`),
              ]}
            />
          </strong>
        ),
...
export default connect(mapStateToProps, { fetchCities })(CustomerUserList);
