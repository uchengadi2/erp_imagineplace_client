          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(`/crm/users/partnerusers/edit/${params.id}`),
              ]}
            />
          </strong>
        ),
          ...
          <strong>
            ...
            <CancelRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(`/crm/users/partnerusers/blacklist/${params.id}`),
              ]}
            />
          </strong>
        ),
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(`/crm/users/partnerusers/delete/${params.id}`),
              ]}
            />
          </strong>
        ),
...
export default connect(mapStateToProps, { fetchCities })(PartnerUsersList);
