...
class AssetInventoryApprovedDisposalList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(
                  `/assets/inventories/approveddisposals/edit/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <CancelRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/assets/inventories/approveddisposals/cancel/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <AssignmentIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/assets/inventories/approveddisposals/assign/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/assets/inventories/approveddisposals/delete/${params.id}`
                ),
              ]}
            />
          </strong>
...
export default connect(null, { fetchOrders })(
  AssetInventoryApprovedDisposalList
);
