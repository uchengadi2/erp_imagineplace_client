...
import AccountUtilityGlCodeForm from "./AccountUtilityGlCodeForm";

class AccountUtilityGlCodeFormContainer extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      open: false,
...
export default connect(null, {})(AccountUtilityGlCodeFormContainer);
