...
class AccountUtilityCashAccountList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
    ...
    return (
      <>
        <Dialog
          ...
          onClose={() => [
            this.setState({ editOpen: false }),
            history.push("/accounts/utilities/cash"),
          ]}
        >
          <DialogContent>
            {/* <OrdersEdit
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(`/accounts/utilities/cash/edit/${params.id}`),
              ]}
            />
          </strong>
        ),
          ...
          <strong>
            ...
            <CancelRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(`/accounts/utilities/cash/cancel/${params.id}`),
              ]}
            />
          </strong>
        ),
          ...
          <strong>
            ...
            <AssignmentIcon
              ...
              onClick={() => [
                ...
                history.push(`/accounts/utilities/cash/assign/${params.id}`),
              ]}
            />
          </strong>
        ),
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(`/accounts/utilities/cash/delete/${params.id}`),
              ]}
            />
          </strong>
        ),
...
export default connect(null, {  })(AccountUtilityCashAccountList);
