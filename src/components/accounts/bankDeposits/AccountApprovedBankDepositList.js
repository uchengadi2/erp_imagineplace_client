...
class AccountApprovedBankDepositList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(
                  `/accounts/bankdeposits/approvedbankdeposits/edit/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <CancelRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/accounts/bankdeposits/approvedbankdeposits/cancel/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <AssignmentIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/accounts/bankdeposits/approvedbankdeposits/assign/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/accounts/bankdeposits/approvedbankdeposits/delete/${params.id}`
                ),
              ]}
            />
          </strong>
...
export default connect(null, {})(AccountApprovedBankDepositList);
