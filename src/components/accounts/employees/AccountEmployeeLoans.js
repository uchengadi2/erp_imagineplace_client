...
class AccountEmployeeLoans extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(`/accounts/employees/loans/edit/${params.id}`),
              ]}
            />
          </strong>
        ),
          ...
          <strong>
            ...
            <CancelRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(`/accounts/employees/loans/cancel/${params.id}`),
              ]}
            />
          </strong>
        ),
          ...
          <strong>
            ...
            <AssignmentIcon
              ...
              onClick={() => [
                ...
                history.push(`/accounts/employees/loans/assign/${params.id}`),
              ]}
            />
          </strong>
        ),
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(`/accounts/employees/loans/delete/${params.id}`),
              ]}
            />
          </strong>
        ),
...
export default connect(null, {})(AccountEmployeeLoans);
