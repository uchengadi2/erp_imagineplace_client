...
class AccountEmployeeMedicalList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(`/accounts/employees/medicals/edit/${params.id}`),
              ]}
            />
          </strong>
        ),
          ...
          <strong>
            ...
            <CancelRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/accounts/employees/medicals/cancel/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <AssignmentIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/accounts/employees/medicals/assign/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/accounts/employees/medicals/delete/${params.id}`
                ),
              ]}
            />
          </strong>
...
export default connect(null, {})(AccountEmployeeMedicalList);
