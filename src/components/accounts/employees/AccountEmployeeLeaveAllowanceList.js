...
class AccountEmployeeLeaveAllowanceList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
    ...
    return (
      <>
        <Dialog
          ...
          onClose={() => [
            this.setState({ editOpen: false }),
            history.push("/accounts/employees/leaveallowances"),
          ]}
        >
          <DialogContent>
            {/* <OrdersEdit
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(
                  `/accounts/employees/leaveallowances/edit/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <CancelRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/accounts/employees/leaveallowances/cancel/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <AssignmentIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/accounts/employees/leaveallowances/assign/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/accounts/employees/leaveallowances/delete/${params.id}`
                ),
              ]}
            />
          </strong>
...
export default connect(null, {})(AccountEmployeeLeaveAllowanceList);
