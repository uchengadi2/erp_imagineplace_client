...
function AccountLedgerStockSubLedgerForm(props) {
  ...
  return (
    <form id="accountLedgerStockSubLedgerForm">
        ...
        >
          ...
          >
            <Typography variant="subtitle1">
              Create Stock Subsidiary Ledger Account
            </Typography>
          </FormLabel>
        </Grid>
...
export default reduxForm({
  form: "accountLedgerStockSubLedgerForm",
