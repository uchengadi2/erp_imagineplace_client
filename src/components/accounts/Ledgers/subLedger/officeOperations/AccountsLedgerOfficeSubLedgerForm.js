...
function AccountsLedgerOfficeSubLedgerForm(props) {
  ...
  const renderOfficeOperationField = ({
    input,
    label,
    meta: { touched, error, invalid },
    type,
    ...
    return (
      <Box>
        <FormControl variant="outlined">
          ...
          <Select
            labelId="officeOperation"
            id="officeOperation"
            //defaultValue={schemeType}
            value={assetType}
            // onChange={props.handleCountryChange}
            onChange={handleAssetTypeChange}
            label="Office Operation & Service"
          ...
          <FormHelperText style={{ marginLeft: 20 }}>
            Select Office Operation & Service
          </FormHelperText>
        </FormControl>
      </Box>
    );
  ...
  return (
    <form id="accountsLedgerSupplierSubLedgerForm">
        ...
        >
          ...
          >
            <Typography variant="subtitle1">
              Create Office Operation & Service Subsidiary Ledger Account
            </Typography>
          </FormLabel>
        </Grid>
              ...
              <Grid container direction="row">
                ...
                <Grid item style={{ width: "52%", marginLeft: 10 }}>
                  <Field
                    label=""
                    id="officeOperation"
                    name="officeOperation"
                    type="text"
                    component={renderOfficeOperationField}
                    style={{ marginTop: 10 }}
                  />
                </Grid>
              </Grid>
...
export default reduxForm({
  form: "accountsLedgerOfficeSubLedgerForm",
})(AccountsLedgerOfficeSubLedgerForm);
