...
class AccountsLedgerOfficeSubLedgerList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
    ...
    return (
      <>
        <Dialog
          ...
          onClose={() => [
            this.setState({ editOpen: false }),
            history.push("/accounts/ledgers/officerssubledgers"),
          ]}
        >
          <DialogContent>
            {/* <OrdersEdit
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(
                  `/accounts/ledgers/officerssubledgers/edit/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <CancelRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/accounts/ledgers/officerssubledgers/cancel/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <AssignmentIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/accounts/ledgers/officerssubledgers/assign/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/accounts/ledgers/officerssubledgers/delete/${params.id}`
                ),
              ]}
            />
          </strong>
...
export default connect(null, {})(AccountsLedgerOfficeSubLedgerList);
