...
function AccountsLedgerProductsSubLedgerForms(props) {
  ...
  const renderProductInfoFileField = ({
    input,
    label,
    meta: { touched, error, invalid },
    type,
    ...
    return (
      <Box>
        <FormControl variant="outlined">
          ...
          <FormHelperText style={{ marginLeft: 20 }}>
            Select Product Information File (PIF)
          </FormHelperText>
        </FormControl>
      </Box>
    );
  ...
  return (
    <form id="accountsLedgerProductsSubLedgerForms">
        ...
        >
          ...
          >
            <Typography variant="subtitle1">
              Create Product Subsidiary Ledger Account
            </Typography>
          </FormLabel>
        </Grid>
              ...
              <Grid container direction="row">
                <Grid item style={{ width: "100%" }}>
                  <Field
                    ...
                    name="pif"
                    type="text"
                    component={renderProductInfoFileField}
                    style={{ marginTop: 10 }}
                  />
                </Grid>
                {/* <Grid item style={{ width: "52%", marginLeft: 10 }}>
...
export default reduxForm({
  form: "accountsLedgerProductsSubLedgerForms",
})(AccountsLedgerProductsSubLedgerForms);
