...
function AccountLedgerStaffLedgerForm(props) {
  ...
  return (
    <form id="accountLedgerStaffLedgerForm">
        ...
        >
          ...
          >
            <Typography variant="subtitle1">
              Create Staff Subsidiary Ledger Account
            </Typography>
          </FormLabel>
        </Grid>
...
export default reduxForm({
  form: "accountLedgerStaffLedgerForm",
