...
class AccountListingIncomeStatementList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
    ...
    return (
      <>
        <Dialog
          ...
          onClose={() => [
            this.setState({ editOpen: false }),
            history.push("/accounts/listings/incomestatements"),
          ]}
        >
          <DialogContent>
            {/* <OrdersEdit
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(
                  `/accounts/listings/incomestatements/edit/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <CancelRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/accounts/listings/incomestatements/cancel/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <AssignmentIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/accounts/listings/incomestatements/assign/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/accounts/listings/incomestatements/delete/${params.id}`
                ),
              ]}
            />
          </strong>
...
export default connect(null, {})(AccountListingIncomeStatementList);
